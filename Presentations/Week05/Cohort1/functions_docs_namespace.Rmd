...
S3 **methods** should be documented in the more complicated cases (or if it includes additional arguements)
...
---
## Imports
`NAMESPACE` controls with external functions can be used by your package without having to use `::`.
